$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowGrouping: true,
        groupSettings: { columns: ['projectOrderNumber'] },
        allowSorting: true,
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'projectOrderNumber', headerText: 'Project Order', textAlign: 'Left', width: 150,
            },
            {
            ...
            {
                field: 'projectTask', headerText: 'Project Task', textAlign: 'Left', width: 100
            },
            {
    ...
    function loadGrid() {
        indo.projectOrderDetails.projectOrderDetail.getListDetail()
            .then(function (data) {
