$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        columns: [
            ...
            {
                field: 'position', headerText: 'Position', textAlign: 'Left', width: 100
            },
            {
    ...
    function reloadGrid() {
        indo.employees.employee.getSalesList()
            .then(function (data) {
    ...
    /* Popup Modal */
    abp.modals.SalesExecutiveModal = function () {
    ...
    var helpModal = new abp.ModalManager(abp.appPath + 'SalesExecutive/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'SalesExecutive/Create',
        modalClass: 'SalesExecutiveModal'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'SalesExecutive/Update',
        modalClass: 'SalesExecutiveModal'
    });
