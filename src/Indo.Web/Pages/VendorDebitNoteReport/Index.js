$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowGrouping: true,
        groupSettings: { columns: ['period', 'vendorDebitNoteNumber'] },
        allowSorting: true,
        sortSettings: { columns: [{ field: 'period', direction: 'Descending' }, {field: 'vendorDebitNoteNumber', direction: 'Ascending'}] },
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'vendorDebitNoteNumber', headerText: 'Debit Note', textAlign: 'Left', width: 150
            },
            {
    ...
    function loadGrid() {
        indo.vendorDebitNoteDetails.vendorDebitNoteDetail.getListDetail()
            .then(function (data) {
