...
namespace Indo.Web.Pages.Buyer
{
    ...
    {
        [BindProperty]
        public BuyerUpdateViewModel Employee { get; set; }
        ...
        public async Task OnGetAsync(Guid id)
        {
            ...
            Employee = ObjectMapper.Map<EmployeeReadDto, BuyerUpdateViewModel>(dto);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                await _employeeAppService.UpdateAsync(
                    Employee.Id,
                    ObjectMapper.Map<BuyerUpdateViewModel, EmployeeUpdateDto>(Employee)
                );
                return NoContent();
        ...
        public class BuyerUpdateViewModel
        {
            [HiddenInput]
