$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowGrouping: true,
        groupSettings: { columns: ['period', 'customerInvoiceNumber'] },
        allowSorting: true,
        sortSettings: { columns: [{ field: 'period', direction: 'Descending' }, {field: 'customerInvoiceNumber', direction: 'Ascending'}] },
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'customerInvoiceNumber', headerText: 'Customer Invoice', textAlign: 'Left', width: 150
            },
            {
    ...
    function loadGrid() {
        indo.customerInvoiceDetails.customerInvoiceDetail.getListDetail()
            .then(function (data) {
