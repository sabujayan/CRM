$(function () {
    ...
    function reloadGrid() {
        indo.cashAndBanks.cashAndBank.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'CashAndBank/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'CashAndBank/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'CashAndBank/Update');
