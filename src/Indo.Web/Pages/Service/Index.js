$(function () {
    ...
    /* Popup Modal */
    abp.modals.ServiceModal = function () {
    ...
    var helpModal = new abp.ModalManager(abp.appPath + 'Service/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Service/Create',
        modalClass: 'ServiceModal'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Service/Update',
        modalClass: 'ServiceModal'
    });
