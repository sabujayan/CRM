$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowGrouping: true,
        groupSettings: { columns: ['receiptOrderNumber'] },
        allowSorting: true,
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'receiptOrderNumber', headerText: 'Goods Receipt', textAlign: 'Left', width: 150,
            },
            {
    ...
    function loadGrid() {
        indo.goodsReceiptDetails.goodsReceiptDetail.getListDetail()
            .then(function (data) {
