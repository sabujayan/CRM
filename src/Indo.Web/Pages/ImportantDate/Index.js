$(function () {
    ...
    function reloadGrid() {
        indo.importantDates.importantDate.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'ImportantDate/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'ImportantDate/Create',
        modalClass: 'ImportantDateCreate'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'ImportantDate/Update',
        modalClass: 'ImportantDateUpdate'
    });
    ...
    /*Calendar View*/
    var calendarViewModal = new abp.ModalManager(abp.appPath + 'ImportantDate/CalendarView');
    ...
    function loadCalendarView() {
        ...
        ej.base.L10n.load({
            'en-US': {
                'schedule': {
                    'newEvent': 'Add ImportantDate',
                    'editEvent': 'Update ImportantDate',
                    'deleteEvent': 'Delete ImportantDate',
                },
            }
        });
