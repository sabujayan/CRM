$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        toolbarClick: (args) => {
            ...
            if (args.item.id === 'DetailsCustom') {
                if (grid.getSelectedRecords().length) {
                    var selectedId = grid.getSelectedRecords()[0].id;
                    window.location.href = '/DeliveryOrder/Detail/' + selectedId
                } else {
                    abp.notify.error(l('SelectRecordError'));
                }
            }
    ...
    function reloadGrid() {
        indo.deliveryOrders.deliveryOrder.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'DeliveryOrder/Help');
