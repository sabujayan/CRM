$(function () {
                ...
                if (grid.getSelectedRecords().length) {
                    ...
                    abp.message.confirm('Delete this data: ' + selectedRow.number)
                        .then(function (confirmed) {
                            if (confirmed) {
                                indo.customerPayments.customerPayment
    ...
    function reloadGrid() {
        indo.customerPayments.customerPayment.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    abp.modals.CustomerPaymentModal = function () {
    ...
    var helpModal = new abp.ModalManager(abp.appPath + 'CustomerPayment/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'CustomerPayment/Create',
        modalClass: 'CustomerPaymentModal'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'CustomerPayment/Update',
        modalClass: 'CustomerPaymentModal'
    });
