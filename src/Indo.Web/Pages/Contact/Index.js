$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        columns: [
            ...
            {
                field: 'email', headerText: 'Email', textAlign: 'Left', width: 100
            },
            {
    ...
    /* Popup Modal */
    abp.modals.ContactModal = function () {
    ...
    var helpModal = new abp.ModalManager(abp.appPath + 'Contact/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Contact/Create',
        modalClass: 'ContactModal'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Contact/Update',
        modalClass: 'ContactModal'
    });
