$(function () {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Activity/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'Activity/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'Activity/Update');
