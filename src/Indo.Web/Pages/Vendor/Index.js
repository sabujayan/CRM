$(function () {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Vendor/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'Vendor/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'Vendor/Update');
