$(function () {
    ...
    function reloadGrid() {
        indo.departments.department.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Department/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'Department/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'Department/Update');
