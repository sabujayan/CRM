$(function () {
    ...
    function reloadGrid() {
        indo.expenseTypes.expenseType.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'ExpenseType/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'ExpenseType/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'ExpenseType/Update');
