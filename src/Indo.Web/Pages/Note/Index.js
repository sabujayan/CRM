$(function () {
        ...
        toolbarClick: (args) => {
            ...
            if (args.item.id === 'DeleteCustom') {
                if (grid.getSelectedRecords().length) {
                    ...
                    abp.message.confirm('Delete this data: ' + selectedRow.description)
    ...
    var helpModal = new abp.ModalManager(abp.appPath + 'Note/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Note/Create',
        modalClass: 'NoteModal'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Note/Update',
        modalClass: 'NoteModal'
    });
