$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowGrouping: true,
        groupSettings: { columns: ['period', 'customerCreditNoteNumber'] },
        allowSorting: true,
        sortSettings: { columns: [{ field: 'period', direction: 'Descending' }, {field: 'customerCreditNoteNumber', direction: 'Ascending'}] },
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'customerCreditNoteNumber', headerText: 'Credit Note', textAlign: 'Left', width: 150
            },
            {
    ...
    function loadGrid() {
        indo.customerCreditNoteDetails.customerCreditNoteDetail.getListDetail()
            .then(function (data) {
