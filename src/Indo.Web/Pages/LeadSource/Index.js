$(function () {
    ...
    function reloadGrid() {
        indo.leadSources.leadSource.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'LeadSource/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'LeadSource/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'LeadSource/Update');
