$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowGrouping: true,
        groupSettings: { columns: ['buyerName'] },
        allowSorting: true,
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'number', headerText: 'Purchase Order', textAlign: 'Left', width: 150,
                template: "<a href='/PurchaseOrder/Detail/${id}' target='_blank'>${number}</a>"
            },
            {
                field: 'buyerName', headerText: 'Buyer', textAlign: 'Left', width: 100
            },
            {
    ...
    function loadGrid() {
        indo.purchaseOrders.purchaseOrder.getListWithTotal()
            .then(function (data) {
