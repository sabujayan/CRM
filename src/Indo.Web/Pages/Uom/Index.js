$(function () {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Uom/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'Uom/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'Uom/Update');
