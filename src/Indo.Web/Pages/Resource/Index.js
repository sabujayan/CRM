$(function () {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Resource/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'Resource/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'Resource/Update');
