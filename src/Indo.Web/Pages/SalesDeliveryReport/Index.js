$(function () {
    ...
    var grid = new ej.grids.Grid({
        ...
        allowGrouping: true,
        groupSettings: { columns: ['salesDeliveryNumber'] },
        allowSorting: true,
        allowFiltering: true,
        ...
        columns: [
            ...
            {
                field: 'salesDeliveryNumber', headerText: 'Sales Delivery', textAlign: 'Left', width: 150
            },
            {
    ...
    function loadGrid() {
        indo.salesDeliveryDetails.salesDeliveryDetail.getListDetail()
            .then(function (data) {
