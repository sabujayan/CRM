$(function () {
    ...
    function reloadGrid() {
        indo.currencies.currency.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Currency/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'Currency/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'Currency/Update');
