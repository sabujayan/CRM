$(function () {
    ...
    function reloadGrid() {
        indo.warehouses.warehouse.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Warehouse/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'Warehouse/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'Warehouse/Update');
