$(function () {
    ...
    function reloadGrid() {
        indo.leadRatings.leadRating.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'LeadRating/Help');
    var createModal = new abp.ModalManager(abp.appPath + 'LeadRating/Create');
    var updateModal = new abp.ModalManager(abp.appPath + 'LeadRating/Update');
