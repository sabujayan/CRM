$(function () {
    ...
    function reloadGrid() {
        indo.calendars.calendar.getList()
            .then(function (data) {
    ...
    /* Popup Modal */
    var helpModal = new abp.ModalManager(abp.appPath + 'Calendar/Help');
    var createModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Calendar/Create',
        modalClass: 'CalendarCreate'
    });
    var updateModal = new abp.ModalManager({
        viewUrl: abp.appPath + 'Calendar/Update',
        modalClass: 'CalendarUpdate'
    });
    ...
    /*Calendar View*/
    var calendarViewModal = new abp.ModalManager(abp.appPath + 'Calendar/CalendarView');
    ...
    function loadCalendarView() {
        ...
        ej.base.L10n.load({
            'en-US': {
                'schedule': {
                    'newEvent': 'Add Calendar',
                    'editEvent': 'Update Calendar',
                    'deleteEvent': 'Delete Calendar',
                },
            }
        });
