...
jQuery(document).ready(function ($) {
    ...
    $(".mstep-nxt-btn").on('click', function () {
        $(this).parents('.mstep').addClass("mhide").next().removeClass("mhide");
    });
    $(".mstep-prv-btn").on('click', function () {
        $(this).parents('.mstep').addClass("mhide").prev().removeClass("mhide");
    });
});
jQuery(document).ready(function ($) {

    $(".multi-next-btn").on('click', function () {
        $(".multi-form-nav").children().find(".active").removeClass("active").parent().next().find(".nav-link").addClass("active");
        $(this).parents('.tab-pane').removeClass("active show").next().addClass("active show");
    });
    $(".multi-prev-btn").on('click', function () {
        $(".multi-form-nav").children().find(".active").removeClass("active").parent().prev().find(".nav-link").addClass("active");
        $(this).parents('.tab-pane').removeClass("active show").prev().addClass("active show");
    });
});
"use strict";
...
jQuery(document).ready(function ($) {
    ...
    $(".web-services input").on('change', function () {

        var attbute = $(this).attr("service-name");

        if (this.checked) {
            $(".project-service-item tbody").find($("tr[service-name*='no-service']")).remove();
            $(".project-service-item tbody").append('<tr service-name="' + attbute + '"><td>' + attbute + '</td><td class="text-end">$' + $(this).val() + '.00</td></tr>');
            sum += Number($(this).val());
        } else {
            $(".project-service-item tbody").find($("tr[service-name*='" + attbute + "']")).remove();
            sum -= Number($(this).val());
        }
        $(".project-sub-total").text(sum);
    });
});
"use strict";
